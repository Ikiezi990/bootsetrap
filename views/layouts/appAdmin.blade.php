...
<head>
    ...
    <link href="{{ asset('template/assets/node_modules/morrisjs/morris.css') }}" rel="stylesheet">
    <!-- Custom CSS -->
    <link href="{{ asset('template/university/dist/css/style.min.css') }}" rel="stylesheet">
    <!-- Dashboard 1 Page CSS -->
    <link href="{{ asset('template/university/dist/css/pages/dashboard1.css') }}" rel="stylesheet">
...
<body class="skin-blue fixed-layout">
    ...
    <div class="preloader">
        <div class="loader">
            ...
            <p class="loader__label">MHC Katalog</p>
        </div>
    </div>
    <!-- ============================================================== -->
                ...
                <div class="navbar-header">
                    <a class="navbar-brand" href="index.html">
                        <!-- Logo icon --><b>
                            ...
                            <!-- Light Logo icon -->
                            <img src="{{ asset('logo.png') }}" alt="homepage" class="light-logo"
                                style="height: 60px;" />
                        </b>
                        <!--End Logo icon -->
                        <span class="hidden-xs"><span class="font-bold">MHC</span>Katalog</span>
                    </a>
                </div>
                <!-- ============================================================== -->
                <!-- End Logo -->
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <div class="message-center">
                                            <!-- Message -->
                                            <a href="javascript:void(0)">
                                                <div class="user-img"> <img src="{{ asset('93.png') }}" alt="user"
                        ...
                        <li class="nav-item dropdown u-pro">
                            <a class="nav-link dropdown-toggle waves-effect waves-dark profile-pic" href=""
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img
                                    src="{{ asset('apatars.jpg') }}" alt="user" class=""> <span
 ...
 <a  href="{{ route('logout') }}"
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        <li class="user-pro"> <a class="has-arrow waves-effect waves-dark" href="javascript:void(0)"
                                aria-expanded="false"><img src="{{ asset('apatars.jpg') }}" alt="user-img"
                                    class="img-circle"><span class="hide-menu"
                                    style="text-transform:uppercase">{{ auth()->user()->name }}</span></a>
                        ...
                        <li class="nav-small-cap">--- Aplication</li>
                        <li> <a class="waves-effect waves-dark" href="{{ url('/home') }}"><i
                                    class="icon-speedometer"></i><span class="hide-menu">Dashboard</span></a>
                        </li>
                        <li> <a class="waves-effect waves-dark" href="{{ route('kategori.index') }}"><i
                                    class="ti-pin-alt"></i><span class="hide-menu">Kategori</span></a>
                        </li>
                        <li> <a class="waves-effect waves-dark" href="{{ route('produk.index') }}"><i
                            class="ti-archive"></i><span class="hide-menu">Produk</span></a>
                </li>
        ...
        <!-- ============================================================== -->
        <footer class="footer">
            © 2022 Team IT SMK Muthia Harapan Cicalengka
        </footer>
        <!-- ============================================================== -->
        <!-- End footer -->
        <!-- ============================================================== -->
    ...
    <script src="{{ asset('template/university/dist/js/perfect-scrollbar.jquery.min.js') }}"></script>
    <!--Wave Effects -->
    <script src="{{ asset('template/university/dist/js/waves.js') }}"></script>
    <!--Menu sidebar -->
    <script src="{{ asset('template/university/dist/js/sidebarmenu.js') }}"></script>
    <!--Custom JavaScript -->
    <script src="{{ asset('template/university/dist/js/custom.min.js') }}"></script>
    <!-- ============================================================== -->
    <!-- This page plugins -->
    <!-- ============================================================== -->
    <!--morris JavaScript -->
    ...
    <!-- Chart JS -->
    <script src="{{ asset('university/dist/js/dashboard1.js') }}"></script>
